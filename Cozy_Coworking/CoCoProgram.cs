...
namespace Cozy_Coworking
{
    class CoCoProgram
    {
        static void Main(string[] args)
        {
            ...
            {
                case "0":
                    Console.WriteLine("This option is under construction - please try again later:");
                    return;
                case "1":
                    Console.WriteLine("This option is under construction - please try again later:");
                    return;
                case "2":
                    ...
                    var myHost = new Host(userName, emailAddress);

                    Console.WriteLine("Please enter the number of coworking spaces you have available:");
                    var myAvailability = Convert.ToInt32(Console.ReadLine());
                    myHost.AddAvailability(myAvailability);
                    ...
                    Console.WriteLine($"Rate {myHost.UserName} as a host. Please enter a number between 1 and 5.");
